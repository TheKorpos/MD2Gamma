...
public class TraceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TracePackage.MD2G_TRACE: {
			MD2GTrace md2GTrace = (MD2GTrace) theEObject;
			T result = caseMD2GTrace(md2GTrace);
			if (result == null)
		...
		case TracePackage.TRACE: {
			...
			if (result == null)
				result = caseAbstractTrace(trace);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TracePackage.INTERFACE_TRACE: {
			InterfaceTrace interfaceTrace = (InterfaceTrace) theEObject;
			T result = caseInterfaceTrace(interfaceTrace);
			if (result == null)
				result = caseAbstractTrace(interfaceTrace);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TracePackage.CONSTRAINT_TRACE: {
			...
			if (result == null)
				result = caseAbstractTrace(constraintTrace);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>MD2G Trace</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>MD2G Trace</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMD2GTrace(MD2GTrace object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Interface Trace</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Interface Trace</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInterfaceTrace(InterfaceTrace object) {
		return null;
	}
