...
public class View extends JFrame {
	...
	public View(ResourceSet resourceSet, File file, boolean needsBackAnnotation, String projectFolderName) throws ViatraQueryException {
		controller = new Controller(this, resourceSet, file, needsBackAnnotation, projectFolderName);
