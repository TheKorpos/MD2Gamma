...
public final class SignalsInStateMachine extends BaseGeneratedEMFQuerySpecification<SignalsInStateMachine.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link SignalsInStateMachine} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SignalsInStateMachine#instance()}.
   * 
