...
public final class RelativeTimeEventsInStateMachine extends BaseGeneratedEMFQuerySpecification<RelativeTimeEventsInStateMachine.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: hu.bme.mit.md2g.transformation.queries.RelativeTimeEventsInStateMachine (visibility: PUBLIC, simpleName: RelativeTimeEventsInStateMachine, identifier: hu.bme.mit.md2g.transformation.queries.RelativeTimeEventsInStateMachine, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.md2g.transformation.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: hu.bme.mit.md2g.transformation.queries.RelativeTimeEventsInStateMachine (visibility: PUBLIC, simpleName: RelativeTimeEventsInStateMachine, identifier: hu.bme.mit.md2g.transformation.queries.RelativeTimeEventsInStateMachine, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.md2g.transformation.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
