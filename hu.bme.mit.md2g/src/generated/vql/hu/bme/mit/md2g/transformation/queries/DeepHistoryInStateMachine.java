...
public final class DeepHistoryInStateMachine extends BaseGeneratedEMFQuerySpecification<DeepHistoryInStateMachine.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link DeepHistoryInStateMachine} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DeepHistoryInStateMachine#instance()}.
   * 
