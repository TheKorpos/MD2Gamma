...
public final class ShallowHistoryInStatemachine extends BaseGeneratedEMFQuerySpecification<ShallowHistoryInStatemachine.Matcher> {
  /**
   * Pattern-specific match representation of the hu.bme.mit.md2g.transformation.queries.ShallowHistoryInStatemachine pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "hu.bme.mit.md2g.transformation.queries.ShallowHistoryInStatemachine";
    }
    
    @Override
    public List<String> parameterNames() {
      return ShallowHistoryInStatemachine.Match.parameterNames;
    }
    ...
    @Override
    public ShallowHistoryInStatemachine.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ShallowHistoryInStatemachine.Match)) {
          ShallowHistoryInStatemachine.Match other = (ShallowHistoryInStatemachine.Match) obj;
    ...
    @Override
    public ShallowHistoryInStatemachine specification() {
     ...
     * 
     */
    public static ShallowHistoryInStatemachine.Match newEmptyMatch() {
     ...
     * 
     */
    public static ShallowHistoryInStatemachine.Match newMutableMatch(final StateMachine pStateMachine, final Pseudostate pHistory) {
     ...
     * 
     */
    public static ShallowHistoryInStatemachine.Match newMatch(final StateMachine pStateMachine, final Pseudostate pHistory) {
      return new Immutable(pStateMachine, pHistory);
    }
    
    private static final class Mutable extends ShallowHistoryInStatemachine.Match {
    ...
    private static final class Immutable extends ShallowHistoryInStatemachine.Match {
  ...
  /**
   * Generated pattern matcher API of the hu.bme.mit.md2g.transformation.queries.ShallowHistoryInStatemachine pattern,
   ...
   * 
   * @see Match
   * @see ShallowHistoryInStatemachine
   * 
   */
  public static class Matcher extends BaseMatcher<ShallowHistoryInStatemachine.Match> {
    /**
     ...
     * 
     */
    public static ShallowHistoryInStatemachine.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ShallowHistoryInStatemachine.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ShallowHistoryInStatemachine.Matcher.class);
     ...
     * 
     */
    public Collection<ShallowHistoryInStatemachine.Match> getAllMatches(final StateMachine pStateMachine, final Pseudostate pHistory) {
     ...
     * 
     */
    public Stream<ShallowHistoryInStatemachine.Match> streamAllMatches(final StateMachine pStateMachine, final Pseudostate pHistory) {
     ...
     * 
     */
    public Optional<ShallowHistoryInStatemachine.Match> getOneArbitraryMatch(final StateMachine pStateMachine, final Pseudostate pHistory) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final StateMachine pStateMachine, final Pseudostate pHistory, final Consumer<? super ShallowHistoryInStatemachine.Match> processor) {
     ...
     * 
     */
    public ShallowHistoryInStatemachine.Match newMatch(final StateMachine pStateMachine, final Pseudostate pHistory) {
      return ShallowHistoryInStatemachine.Match.newMatch(pStateMachine, pHistory);
    }
     ...
     * 
     */
    public Stream<StateMachine> streamAllValuesOfstateMachine(final ShallowHistoryInStatemachine.Match partialMatch) {
     ...
     * 
     */
    public Set<StateMachine> getAllValuesOfstateMachine(final ShallowHistoryInStatemachine.Match partialMatch) {
     ...
     * 
     */
    public Stream<Pseudostate> streamAllValuesOfhistory(final ShallowHistoryInStatemachine.Match partialMatch) {
     ...
     * 
     */
    public Set<Pseudostate> getAllValuesOfhistory(final ShallowHistoryInStatemachine.Match partialMatch) {
    ...
    @Override
    protected ShallowHistoryInStatemachine.Match tupleToMatch(final Tuple t) {
      try {
          return ShallowHistoryInStatemachine.Match.newMatch((StateMachine) t.get(POSITION_STATEMACHINE), (Pseudostate) t.get(POSITION_HISTORY));
    ...
    @Override
    protected ShallowHistoryInStatemachine.Match arrayToMatch(final Object[] match) {
      try {
          return ShallowHistoryInStatemachine.Match.newMatch((StateMachine) match[POSITION_STATEMACHINE], (Pseudostate) match[POSITION_HISTORY]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ShallowHistoryInStatemachine.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ShallowHistoryInStatemachine.Match.newMutableMatch((StateMachine) match[POSITION_STATEMACHINE], (Pseudostate) match[POSITION_HISTORY]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ShallowHistoryInStatemachine.Matcher> querySpecification() {
      return ShallowHistoryInStatemachine.instance();
    }
  }
  
  private ShallowHistoryInStatemachine() {
   ...
   * 
   */
  public static ShallowHistoryInStatemachine instance() {
    try{
  ...
  @Override
  protected ShallowHistoryInStatemachine.Matcher instantiate(final ViatraQueryEngine engine) {
    return ShallowHistoryInStatemachine.Matcher.on(engine);
  }
  
  @Override
  public ShallowHistoryInStatemachine.Matcher instantiate() {
    return ShallowHistoryInStatemachine.Matcher.create();
  }
  
  @Override
  public ShallowHistoryInStatemachine.Match newEmptyMatch() {
    return ShallowHistoryInStatemachine.Match.newEmptyMatch();
  }
  
  @Override
  public ShallowHistoryInStatemachine.Match newMatch(final Object... parameters) {
    return ShallowHistoryInStatemachine.Match.newMatch((com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.StateMachine) parameters[0], (com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.Pseudostate) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: hu.bme.mit.md2g.transformation.queries.ShallowHistoryInStatemachine (visibility: PUBLIC, simpleName: ShallowHistoryInStatemachine, identifier: hu.bme.mit.md2g.transformation.queries.ShallowHistoryInStatemachine, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.md2g.transformation.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: hu.bme.mit.md2g.transformation.queries.ShallowHistoryInStatemachine (visibility: PUBLIC, simpleName: ShallowHistoryInStatemachine, identifier: hu.bme.mit.md2g.transformation.queries.ShallowHistoryInStatemachine, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.md2g.transformation.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ShallowHistoryInStatemachine INSTANCE = new ShallowHistoryInStatemachine();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ShallowHistoryInStatemachine.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.PseudostateKindEnum.get("shallowHistory"));
          new TypeConstraint(body, Tuples.flatTupleOf(var_history), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "Pseudostate")));
