...
public final class ForksInStateMachine extends BaseGeneratedEMFQuerySpecification<ForksInStateMachine.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public Object get(final String parameterName) {
      ...
      if ("forkState".equals(parameterName)) return this.fForkState;
      return null;
    }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: hu.bme.mit.md2g.transformation.queries.ForksInStateMachine (visibility: PUBLIC, simpleName: ForksInStateMachine, identifier: hu.bme.mit.md2g.transformation.queries.ForksInStateMachine, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.md2g.transformation.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: hu.bme.mit.md2g.transformation.queries.ForksInStateMachine (visibility: PUBLIC, simpleName: ForksInStateMachine, identifier: hu.bme.mit.md2g.transformation.queries.ForksInStateMachine, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.md2g.transformation.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
