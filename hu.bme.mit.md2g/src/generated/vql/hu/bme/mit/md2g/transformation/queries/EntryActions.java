...
public final class EntryActions extends BaseGeneratedEMFQuerySpecification<EntryActions.Matcher> {
  /**
   * Pattern-specific match representation of the hu.bme.mit.md2g.transformation.queries.EntryActions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "hu.bme.mit.md2g.transformation.queries.EntryActions";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntryActions.Match.parameterNames;
    }
    ...
    @Override
    public EntryActions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntryActions.Match)) {
          EntryActions.Match other = (EntryActions.Match) obj;
    ...
    @Override
    public EntryActions specification() {
     ...
     * 
     */
    public static EntryActions.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntryActions.Match newMutableMatch(final State pState, final String pBody, final Behavior pEffect) {
     ...
     * 
     */
    public static EntryActions.Match newMatch(final State pState, final String pBody, final Behavior pEffect) {
      return new Immutable(pState, pBody, pEffect);
    }
    
    private static final class Mutable extends EntryActions.Match {
    ...
    private static final class Immutable extends EntryActions.Match {
  ...
  /**
   * Generated pattern matcher API of the hu.bme.mit.md2g.transformation.queries.EntryActions pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<EntryActions.Match> {
    /**
     ...
     * 
     */
    public static EntryActions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntryActions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntryActions.Matcher.class);
     ...
     * 
     */
    public Collection<EntryActions.Match> getAllMatches(final State pState, final String pBody, final Behavior pEffect) {
     ...
     * 
     */
    public Stream<EntryActions.Match> streamAllMatches(final State pState, final String pBody, final Behavior pEffect) {
     ...
     * 
     */
    public Optional<EntryActions.Match> getOneArbitraryMatch(final State pState, final String pBody, final Behavior pEffect) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final State pState, final String pBody, final Behavior pEffect, final Consumer<? super EntryActions.Match> processor) {
     ...
     * 
     */
    public EntryActions.Match newMatch(final State pState, final String pBody, final Behavior pEffect) {
      return EntryActions.Match.newMatch(pState, pBody, pEffect);
    }
     ...
     * 
     */
    public Stream<State> streamAllValuesOfstate(final EntryActions.Match partialMatch) {
     ...
     * 
     */
    public Set<State> getAllValuesOfstate(final EntryActions.Match partialMatch) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfbody(final EntryActions.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfbody(final EntryActions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Behavior> streamAllValuesOfeffect(final EntryActions.Match partialMatch) {
     ...
     * 
     */
    public Set<Behavior> getAllValuesOfeffect(final EntryActions.Match partialMatch) {
    ...
    @Override
    protected EntryActions.Match tupleToMatch(final Tuple t) {
      try {
          return EntryActions.Match.newMatch((State) t.get(POSITION_STATE), (String) t.get(POSITION_BODY), (Behavior) t.get(POSITION_EFFECT));
    ...
    @Override
    protected EntryActions.Match arrayToMatch(final Object[] match) {
      try {
          return EntryActions.Match.newMatch((State) match[POSITION_STATE], (String) match[POSITION_BODY], (Behavior) match[POSITION_EFFECT]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntryActions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntryActions.Match.newMutableMatch((State) match[POSITION_STATE], (String) match[POSITION_BODY], (Behavior) match[POSITION_EFFECT]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntryActions.Matcher> querySpecification() {
      return EntryActions.instance();
    }
  }
   ...
   * 
   */
  public static EntryActions instance() {
    try{
  ...
  @Override
  protected EntryActions.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntryActions.Matcher.on(engine);
  }
  
  @Override
  public EntryActions.Matcher instantiate() {
    return EntryActions.Matcher.create();
  }
  
  @Override
  public EntryActions.Match newEmptyMatch() {
    return EntryActions.Match.newEmptyMatch();
  }
  
  @Override
  public EntryActions.Match newMatch(final Object... parameters) {
    return EntryActions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.State) parameters[0], (java.lang.String) parameters[1], (com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: hu.bme.mit.md2g.transformation.queries.EntryActions (visibility: PUBLIC, simpleName: EntryActions, identifier: hu.bme.mit.md2g.transformation.queries.EntryActions, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.md2g.transformation.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: hu.bme.mit.md2g.transformation.queries.EntryActions (visibility: PUBLIC, simpleName: EntryActions, identifier: hu.bme.mit.md2g.transformation.queries.EntryActions, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.md2g.transformation.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntryActions INSTANCE = new EntryActions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntryActions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_state, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "State", "entry")));
