...
public final class RegionsInStates extends BaseGeneratedEMFQuerySpecification<RegionsInStates.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public Object get(final String parameterName) {
      switch(parameterName) {
          case "containingState": return this.fContainingState;
    ...
    public Object get(final int index) {
      switch(index) {
          case 0: return this.fContainingState;
  ...
  /**
   * Inner class allowing the singleton instance of {@link RegionsInStates} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RegionsInStates#instance()}.
   * 
